/**
 * Unofficial TypeScript client — lk-flood-api (nuuuwan)
 *
...
const DEFAULT_UA = "lk-flood-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/lk-flood-api-docs; educational; polite)";

function sleep(ms: number): Promise<void> {
  return new Promise((resolve) => setTimeout(resolve, ms));
}

export class LkFloodApiDocsClient {
  ...
  constructor(options: ClientOptions = {}) {
    this.baseUrl = (options.baseUrl ?? "https://nuuuwan.github.io").replace(/\/$/, "");
  ...
  static readonly slug = "lk-flood-api-docs";
  static readonly title = "lk-flood-api (nuuuwan)";
   ...
   */
  async floodLatest(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://raw.githubusercontent.com/nuuuwan/lk_flood/data/lk_flood.json", options.query), { ...options, method: "GET" });
  }
}

export default LkFloodApiDocsClient;
